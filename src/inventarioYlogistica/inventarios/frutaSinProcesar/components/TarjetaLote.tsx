            ...
            {moreInfo &&
                <View style={styles.descarteContainer}>
                    ...
                    <View style={styles.buttonsContainer}>
                        <Button title="Directo Nacional" color={'red'} onPress={() => props.handleDirectoNacional(props.data)} />
                        {props.data.tipoFruta === 'Naranja' &&
                            <Button title="Desverdizado" color={'orange'} onPress={() => props.handleDesverdizado(props.data)} />
                        }
                    </View>
                </View>
            }
